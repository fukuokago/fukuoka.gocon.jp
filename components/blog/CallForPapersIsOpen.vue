...
export default class CallForPapersIsOpen extends Vue {
  ...
  get permalink(): string {
    return this.localePath({ name: 'blog-slug', params: { slug: 'call-for-papers-is-open' } })
  }
}
</script>
