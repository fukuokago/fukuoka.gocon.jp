...
en:
  ...
  sponsors:
    - name: GMO Pepabo, inc.
      desc: |-
        GMO Pepabo, Inc., based in Tokyo, Fukuoka and Kagoshima, will be Japan's largest handmade market "minne",
        server hosting "Lollipop!", Online shop service "Color Me Shop" and
    ...
    - name: Circulation, Inc.
      desc: |-
        Circulation has Japan's largest "professional human resource sharing service".
        With the vision of "Creation a society in which experiences and knowledge around the world circulate".
    ...
    - name: DeNA Co., Ltd.
      desc: |-
        ...
        Founded in 1999, DeNA built a core competency in internet technology,
        but as that becomes increasingly commodified, DeNA is now developing a core competence in AI, and making use of this technology across its businesses.
        DeNA’s mission is to Delight and Impact the World, and DeNA aims to, as an eternal venture, bring delight to the world using the internet and AI.
...
ja:
  ...
  sponsors:
    - name: GMOペパボ株式会社
      desc: |-
        GMOペパボ株式会社は、東京と福岡と鹿児島を拠点に、日本最大級のハンドメイドマーケット「minne」やレンタルサーバー「ロリポップ！」、
        ネットショップ開業・作成サービス「カラーミーショップ」、ブログサービス「JUGEM」をメインとした
    ...
    - name: 株式会社サーキュレーション
      desc: |-
        サーキュレーションは「世界中の経験・知見が循環する社会の創造」をビジョンに掲げる、
        日本最大規模のプロシェアリングサービス（プロ人材の高い専門性を複数企業でシェア）を展開する企業です。
    ...
    - name: 株式会社ディー・エヌ・エー
      desc: |-
        1999年に創業した株式会社ディー・エヌ・エー(以下DeNA)はゲーム事業を中心に、
        近年では、オートモーティブ事業やヘルスケア事業、スポーツ事業などにも進出し、多種多様な事業を展開しています。
        インターネット技術がコモディティー化する中、次の支える柱としてAI技術に注目し、事業を横断して活用しています。
        DeNAのミッションは Delight and Impact the World です。
        インターネットやAIを活用し、永久ベンチャーとして世の中にデライトを届けることを長期の経営指針として、世の中に貢献し歓迎されるような新しい価値を提供すべく、挑戦を続けています。
      url: https://dena.com/jp/recruit/career/engineer/
      slug: dena
      ext: svg
    - name: 株式会社Fusic
